...
There are recurring questions - center around how many requests should be supported, file modalities and supported user interfaces.
2. Propose a high-level schema
Draw boxes to get understanding of the schema. Involve the intervewer to get agreement on the high-level design.
3. Go deeper and expand on the schema
Expand the boxes - the DB, memory, cache, load balancing, state, etc
4. Answer questions or talk about additional points
Talk about anything that might show deper understanding - bottlenecks, failure modes, scaling.
